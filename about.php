<!DOCTYPE html>
    ...
    <div class="d-flex justify-content-end p-1">
          <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="./sinhala/about.php" style="color: white;"><b>සිංහල</b></a></button>
          <!-- <button class="btn rounded-5 me-2 shadow tran_btn"><a href="./index.php" style="color: white;"><b>English</b></a></button> -->
          <button class="btn rounded-5 shadow tran_btn"><a href="./Tamil/about.php" style="color: white;"><b>தமிழ்</b></a></button>
        </div>
        ...
        <main class="main">
            ...
            <div class="page-title">
                <div class="container d-lg-flex justify-content-between align-items-center">
                    <h1 class="mb-2 mb-lg-0">AboutUs</h1>
                    <nav class="breadcrumbs">
                        <ol>
                            <li><a href="index.php">Home</a></li>
                            <li class="current">AboutUs</li>
                        </ol>
                    </nav>
                </div>
            </div>
