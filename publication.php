      ...
      <div class="d-flex justify-content-end p-1">
          <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="./sinhala/publication.php" style="color: white;"><b>සිංහල</b></a></button>
          <button class="btn rounded-5 shadow tran_btn"><a href="./Tamil/publication.php" style="color: white;"><b>தமிழ்</b></a></button>
        </div>
