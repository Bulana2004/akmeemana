      ...
      <div class="d-flex justify-content-end p-1">
        <button class="btn rounded-5 me-2 shadow tran_btn"><a href="../sinhala/publication.php" style="color: white;">සිංහල</a></button>
        <button class="btn rounded-5 me-2 shadow tran_btn"><a href="../publication.php" style="color: white;">English</a></button>
        ...
        <main class="main">
            <div class="page-title">
                <div class="container d-lg-flex justify-content-between align-items-center">
                    <h1 class="mb-1 mb-lg-0">வெளியீடு</h1>
                    <nav class="breadcrumbs">
                    <ol>
                        <li><a href="./index.php">முகப்பு பக்கம்</a></li>
                        <li class="current">வெளியீடு</li>
                    </ol>
                    </nav>
                </div>
            </div>
