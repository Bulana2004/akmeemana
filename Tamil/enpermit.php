...
<body class="about-page">
  ...
  <div class="logo_section container d-flex">
    ...
    <div class="language_btn d-flex justify-content-end align-items-center w-100">
      ...
      <a href="../enpermit.php"><button class="btn ms-3">English</button></a>
    </div>
  </div>
  ...
  <main class="main">
    ...
    <div class="page-title">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">சுற்றுச்சூழல் அனுமதி வைத்திருப்பவர்கள்</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="./index.php">முகப்பு பக்கம்</a></li>
            <li class="current">சுற்றுச்சூழல் அனுமதி வைத்திருப்பவர்கள்</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="container">
        <div class="exelsheet">
            <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTH_PqJWQQg3Xe7ABpCErPR2sQzmjWNbspqZSn5eQHq0RJHA9qP9ql8EfSPOYrWiWJMJGvivQNeX0Gh/pubhtml?gid=1664402961&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
        </div>
    </div>
