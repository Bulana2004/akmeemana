...
<body class="about-page">
  ...
  <div class="logo_section container d-flex">
    ...
    <div class="language_btn d-flex justify-content-end align-items-center w-100">
      ...
      <a href="../booking.php"><button class="btn ms-3">English</button></a>
    </div>
  </div>
      ...
      <div class="row justify-content-center g-5">
        <div class="col-lg-4 d-flex justify-content-center">
          <div class="p-5 booking_cards border rounded-5 shadow h-100">
            ...
            <hr>
            <a href="https://psmis.lk/crbooksel.php?vals=1aH107406HBGD" target="_blank"><button class="btn btn-primary mt-2">இப்போதே முன்பதிவு செய்யுங்கள்</button></a>
          </div>
        </div>
      </div>
    </section>
