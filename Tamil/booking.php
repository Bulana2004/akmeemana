...
<body class="about-page">
    ...
    <div class="d-flex justify-content-end p-1">
        <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="./../sinhala/booking.php" style="color: white;">සිංහල</a></button>
        <button class="btn rounded-5 me-2 shadow tran_btn"><a href="../booking.php" style="color: white;">English</a></button>
        <!-- <button class="btn rounded-5 shadow tran_btn"><a href="../Tamil/booking.php" style="color: white;">தமிழ்</a></button> -->
    </div>
    ...
    <main class="main">
        ...
        <div class="page-title">
            <div class="container d-lg-flex justify-content-between align-items-center">
                <h1 class="mb-2 mb-lg-0">முன்பதிவுகள்</h1>
                <nav class="breadcrumbs">
                    <ol>
                        <li><a href="./index.php">முகப்பு பக்கம்</a></li>
                        <li class="current">முன்பதிவுகள்</li>
                    </ol>
                </nav>
            </div>
        </div>
