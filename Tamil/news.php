    ...
    <body class="about-page">
      ...
      <div class="logo_section container d-flex">
        ...
        <div class="language_btn d-flex justify-content-end align-items-center w-100">
          <a href="../sinhala/news.php"><button class="btn">සිංහල</button></a>
          <a href="../news.php"><button class="btn ms-3">English</button></a>
        </div>
      </div>
      ...
      <main class="main">
        ...
        <section id="about" class="about section">
          ...
          <div class="container">
            <?php
            $sql = $bdd->prepare("SELECT * FROM tam_news ORDER BY date DESC");
            $sql->execute();
            $count = 0;
            ?>
