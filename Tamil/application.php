    ...
    <div class="d-flex justify-content-end p-1">
          <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="../sinhala/application.php" style="color: white;">සිංහල</a></button>
        ...
        <main class="main">
            ...
            <div class="page-title">
                <div class="container d-lg-flex justify-content-between align-items-center">
                    <h1 class="mb-2 mb-lg-0">விண்ணப்பங்கள்</h1>
                    <nav class="breadcrumbs">
                        <ol>
                            <li><a href="index.php">முகப்பு பக்கம்</a></li>
                            <li class="current">விண்ணப்பம்</li>
                        </ol>
                    </nav>
                </div>
            </div>
