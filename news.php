    ...
    <div class="d-flex justify-content-end p-1">
          <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="./sinhala/news.php" style="color: white;"><b>සිංහල</b></a></button>
          <!-- <button class="btn rounded-5 me-2 shadow tran_btn"><a href="./index.php" style="color: white;"><b>English</b></a></button> -->
          <button class="btn rounded-5 shadow tran_btn"><a href="./Tamil/news.php" style="color: white;"><b>தமிழ்</b></a></button>
        </div>
                ...
                <ul>
                    ...
                    <?php 
                        if ($data[3]) { 
                            ...
                            ?>
                            <li class="dropdown">
                                <a class="<?= $is_activeDropdowns ?>" href="<?= $link[0] ?>">
                                    <span><?= $name[0] ?></span> <i class="bi bi-chevron-down toggle-dropdown"></i>
                                </a>
                                <ul>
                                    <?php
            ...
            <?php while ($data = $sql->fetch()) { ?>
              ...
              <div class="row gy-4">
                <?php if ($count % 2 != 0) { ?>
                  ...
                  <div id="<?= $id ?>" class="col-lg-6 about-images order-1 order-lg-2 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="col-lg-6 content order-2 order-lg-1 mb-5" data-aos="fade-up" data-aos-delay="100">
                    <p class="who-we-are"><?= $data[4] ?></p>
                    <h3><?= $data[2] ?></h3>
                    <p class=""><?= $data[3] ?></p>
                  </div>
                ...
                <?php } else { ?>
                  <!-- Mobile First Carousel -->
                  <div id="<?= $id ?>" class="col-lg-6 about-images order-1 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
                    <div id="<?= $carouselId ?>" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="./controllers/assets/img/news/<?= $img[0] ?>" class="d-block w-100" alt="...">
                  ...
                  <!-- Text Content Second on Mobile -->
                  <div class="col-lg-6 content order-2 mb-5" data-aos="fade-up" data-aos-delay="100">
                    <p class="who-we-are"><?= $data[4] ?></p>
                    <h3><?= $data[2] ?></h3>
                    <p class=""><?= $data[3] ?></p>
                  </div>
