          ...
          <section id="lifestyle-category" class="lifestyle-category section">
            <div class="row newsAndtender">
                ...
                <div class="container" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="row g-5">
                    <div class="col-lg-6">
                      ...
                      <?php
                      $sql = $bdd->prepare("SELECT * FROM sin_news ORDER BY date DESC LIMIT 1");
                      $sql->execute();
                      while ($data = $sql->fetch()) {
                        $img = explode(',', $data[1]);
                        $Id = $data[0];
                      ...
                      <?php
                      $sql = $bdd->prepare("SELECT * FROM sin_news ORDER BY date DESC LIMIT 1, 2");
                      $sql->execute();
                    ...
                    <div class="col-lg-6">
                      <div class="row g-5">
                        ...
                        <div class="col-lg-10 border-start custom-border">
                          <?php
                          $sql = $bdd->prepare("SELECT * FROM sin_news ORDER BY date DESC LIMIT 3, 3");
                          $sql->execute();
                          while ($data = $sql->fetch()) {
                            $img = explode(",", $data[1]);
                            $Id = $data[0];
              ...
              <div class="col-lg-4">
                ...
                <?php
                $sql = $bdd->prepare("SELECT * FROM sin_tenders ORDER BY date DESC LIMIT 5");
                $sql->execute();
