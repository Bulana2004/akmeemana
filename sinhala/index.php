      ...
      <body class="index-page">
        ...
        <div class="d-flex justify-content-end p-1">
          <!-- <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="./index.php" style="color: white;"><b>සිංහල</b></a></button> -->
          <button class="btn rounded-5 me-2 shadow tran_btn"><a href="./../index.php" style="color: white;"><b>English</b></a></button>
          <button class="btn rounded-5 shadow tran_btn"><a href="../Tamil/index.php" style="color: white;"><b>தமிழ்</b></a></button>
        </div>
            ...
            <div class="row gy-4">
              <div class="col-lg-4 col-md-6 footer-about">
                ...
                <div class="social-links d-flex mt-4">
                  ...
                  <a href="https://play.google.com/store/apps/details?id=io.akva.esabha&pcampaignid=web_share" target="_blank" style="color: #0074b1;border-color:#0074b1;"><i class="bi bi-bank"></i></a> <span class="mt-2"  style="color: #0074b1;border-color:#0074b1;">eSabha යෙදුම</span>
                </div>
              </div>
