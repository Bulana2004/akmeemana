...
<body class="about-page">
    ...
    <div class="logo_section container d-flex">
        ...
        <div class="language_btn d-flex justify-content-end align-items-center w-100">
            <a href="../enpermit.php"><button class="btn">English</button></a>
    ...
    <main class="main">
        ...
        <div class="page-title">
            <div class="container d-lg-flex justify-content-between align-items-center">
                <h1 class="mb-2 mb-lg-0">පරිසර බලපත්‍ර දරන්නන්.</h1>
                <nav class="breadcrumbs">
                    <ol>
                        <li><a href="./index.php">මුල් පිටුව</a></li>
                        <li class="current">පරිසර බලපත්‍ර දරන්නන්.</li>
                    </ol>
                </nav>
            </div>
        </div>
        <!-- End Page Title -->
            ...
            <div class="container">
                <div class="exelsheet">
                    <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQzBNEH9GFxX65xR5z5RPHcpyTGgCd2XZgfC0-vr7lOi4_yf3sOutxgcspksZiZNhHgfqFrPYZ1Cqat/pubhtml?gid=1899220910&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
                </div>
            </div>
