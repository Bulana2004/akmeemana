<!DOCTYPE html>
    ...
    <div class="d-flex justify-content-end p-1">
          ...
          <button class="btn rounded-5 me-2 shadow tran_btn"><a href="../application.php" style="color: white;">English</a></button>
          <button class="btn rounded-5 shadow tran_btn"><a href="../Tamil/application.php" style="color: white;">தமிழ்</a></button>
        </div>
        ...
        <main class="main">
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                            <a href="#" target="_blank">
                                <div class="service-item text-center pt-3">
                                    <div class="p-1">
                                        <h5 class="mb-3">වෙළඳ ව්‍යපාරයක් පවත්වාගෙන යාම සඳහා ඉල්ලුම් පත්‍රය.</h5>
                                    </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                        <a href="#" target="_blank">
                            <div class="service-item text-center pt-3">
                                <div class="p-1">
                                    <h5 class="mb-3">බැඳුම්කර නොවන / වීදි රේඛා සහතිකයක් ලබා ගැනීම සඳහා අයදුම් පත්‍රය.</h5>
                                </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="#" target="_blank">
                        <div class="service-item text-center pt-3">
                            <div class="p-1">
                                <h5 class="mb-3">අන්තරායකර ගස් ඉවත් කරන ලෙස ඉල්ලා අයදුම් පත්‍රය.</h5>
                            </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                <a href="#" target="_blank">
                    <div class="service-item text-center pt-3">
                        <div class="p-1">
                            <h5 class="mb-3">අවමංගල්‍යාගරය වෙන් කිරීම සඳහා ඉල්ලුම් පත්‍රය.</h5>
                        </div>
                </a>
            </div>
            </div>
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                <a href="#" target="_blank">
                    <div class="service-item text-center pt-3">
                        <div class="p-1">
                            <h5 class="mb-3">දේපල හිමිකාරිත්ව සහතිකය / හිමිකාරීත්වය තහවුරු කිරීම සඳහා අයදුම් පත්‍රය.</h5>
                        </div>
                </a>
            </div>
            </div>
