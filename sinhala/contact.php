...
<body class="contact-page">
  ...
  <div class="d-flex justify-content-end p-1">
    ...
    <button class="btn rounded-5 shadow tran_btn"><a href="../Tamil/contact.php" style="color: white;">தமிழ்</a></button>
  </div>
  ...
  <main class="main">
    ...
    <div class="page-title">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">අමතන්න</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="./index.php">මුල්පිටුව</a></li>
            <li class="current">අමතන්න</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
            ...
            <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
              <div class="row gy-4">
                ...
                <div class="col-md-12 text-center">
                  ...
                  <button type="submit">කෙටිපණිවිඩය යවන්න</button>
                </div>
