<!DOCTYPE html>
      ...
      <div class="d-flex justify-content-end p-1">
          ...
          <button class="btn rounded-5 me-2 shadow tran_btn"><a href="../tenders.php" style="color: white;">English</a></button>
          <button class="btn rounded-5 shadow tran_btn"><a href="../Tamil/tenders.php" style="color: white;">தமிழ்</a></button>
        </div>
        ...
        <main class="main">
            <div class="page-title">
                <div class="container d-lg-flex justify-content-between align-items-center">
                    <h1 class="mb-2 mb-lg-0">ටෙන්ඩර් දැන්වීම්</h1>
                    <nav class="breadcrumbs">
                    <ol>
                        <li><a href="./index.php">මුල්පිටුව</a></li>
                        <li class="current">ටෙන්ඩර් දැන්වීම්</li>
                    </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="container mb-5 mt-5">
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <?php
                  $sql = $bdd -> prepare('SELECT * FROM sin_tenders ORDER BY id DESC');
                  $sql -> execute();
