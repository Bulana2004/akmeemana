...
<body class="index-page">
  ...
  <div class="logo_section container d-flex">
    ...
    <div class="language_btn d-flex justify-content-end align-items-center w-100">
      <a href="../tenders.php"><button class="btn">English</button></a>
      <a href="../Tamil/tenders.php"><button class="btn ms-3">தமிழ்</button></a>
    </div>
  </div>
  ...
  <main class="main">
    ...
    <div class="container mb-5 mt-5">
      <div class="accordion accordion-flush" id="accordionFlushExample">
        <?php
        $sql = $bdd->prepare('SELECT * FROM sin_tenders ORDER BY date DESC');
        $sql->execute();
