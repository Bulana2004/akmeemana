...
<body class="about-page">
  ...
  <div class="logo_section container d-flex">
    ...
    <div class="language_btn d-flex justify-content-end align-items-center w-100">
      <a href="../news.php"><button class="btn">English</button></a>
      <a href="../Tamil/news.php"><button class="btn ms-3">தமிழ்</button></a>
    </div>
  </div>
  ...
  <main class="main">
    ...
    <div class="page-title">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">පුවත්</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="./index.php">මුල්පිටුව</a></li>
            <li class="current">පුවත්</li>
          </ol>
        </nav>
      </div>
    </div>
