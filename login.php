              ...
              <div class="bg-white p-4 p-md-5 rounded shadow-sm">
                ...
                <form id="formSubmit">
                  <div class="row gy-3 gy-md-4 overflow-hidden">
                    <div class="col-12">
                      <label for="text" class="form-label">User <span class="text-danger">*</span></label>
                    ...
                    <div id="output" class="alert alert-danger" role="alert" hidden>
