                ...
                <div class="swiper-wrapper">
                  ...
                  <?php while ($data = $sql->fetch()) { ?>
                    <div class="swiper-slide" style="background-image: url('./controllers/assets/img/slider/<?= $data[1] ?>');">
                      <div class="content">
                        <h1 class="slider-h1"><a href="./about.php"><b>Akmeemana</b> <br> Pradeshiya Sabha</a></h1>
                        <a href="./about.php">
                          <button class="btn slider-button" style="background-color: #00659d; color: white;">Read more</button>
                        </a>
                      </div>
                    </div>
                  <?php } ?>
          ...
          <section class="container  mb-5">
            <div class="row">
              <div class="col-lg-3 d-flex g-5" data-aos="fade-up" data-aos-delay="100">
                <div class="home-card border h-100 w-100 p-5 text-center shadow">
          ...
          <section id="lifestyle-category" class="lifestyle-category section">
            <div class="row newsAndtender">
                ...
                <div class="container" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="row g-5">
                    <div class="col-lg-6">
                      ...
                      <?php
                      $sql = $bdd->prepare("SELECT * FROM news ORDER BY date DESC LIMIT 1");
                      $sql->execute();
                      while ($data = $sql->fetch()) {
                        $img = explode(',', $data[1]);
                        $Id = $data[0];
                      ...
                      <?php
                      $sql = $bdd->prepare("SELECT * FROM news ORDER BY date DESC LIMIT 1, 2");
                      $sql->execute();
                    ...
                    <div class="col-lg-6">
                      <div class="row g-5">
                        ...
                        <div class="col-lg-10 border-start custom-border">
                          <?php
                          $sql = $bdd->prepare("SELECT * FROM news ORDER BY date DESC LIMIT 3, 3");
                          $sql->execute();
                          while ($data = $sql->fetch()) {
                            $img = explode(",", $data[1]);
                            $Id = $data[0];
              ...
              <div class="col-lg-4">
                ...
                <?php
                $sql = $bdd->prepare("SELECT * FROM tenders ORDER BY date DESC LIMIT 5");
                $sql->execute();
