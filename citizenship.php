        ...
        <div class="d-flex justify-content-end p-1">
          <button class="btn rounded-5 me-2 shadow tran_btn" ><a href="./sinhala/citizenship.php" style="color: white;"><b>සිංහල</b></a></button>
          <!-- <button class="btn rounded-5 me-2 shadow tran_btn"><a href="./index.php" style="color: white;"><b>English</b></a></button> -->
          <button class="btn rounded-5 shadow tran_btn"><a href="./Tamil/citizenship.php" style="color: white;"><b>தமிழ்</b></a></button>
        </div>
            ...
            <main class="main">
                ...
                <div class="container">
                    ...
                    <div class="mt-4">
                <embed src="pdf/citizenship(Not pdf).pdf" type="application/pdf" width="100%" height="700px" />
            </div>
                </div>
                <br>
            </main>
